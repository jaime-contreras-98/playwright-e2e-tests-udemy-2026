...
test.describe("Set up appointment", { annotation: { type: 'Story', description: 'LOCAL404-1122' }, tag: '@smoke-suite' }, () => {
  ...
  test("Should be able to make an appointment with non default values", { annotation: { type: 'Bug', description: 'LOCAL404-1123' }, tag: '@smoke' }, async ({ page, browserName }) => {
